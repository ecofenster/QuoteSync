...
- Installation Materials and Installation consume one Estimate-owned Installation Profile/snapshot. Administration owns reusable workforce, productivity, travel and rate defaults; the Estimate owns the selected team, position requirements, route/programme assumptions and overrides. Team recommendations must filter capability and crew before travel ranking, while actual team selection remains user-authoritative.
