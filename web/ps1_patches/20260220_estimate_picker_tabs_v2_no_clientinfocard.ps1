# QuoteSync - Fix Estimate Picker tabs: remove ClientInfoCard dependency + replace block safely
# File: 20260220_estimate_picker_tabs_v2_no_clientinfocard.ps1
...
# 1) Insert state block once (anchor: pickerClient memo)
...
Ok "Replaced Estimate Picker block with tabbed UI (no ClientInfoCard)."
