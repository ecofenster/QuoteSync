# QuoteSync patch: Follow Ups details panel only populates when a follow-up is selected (and moves to bottom panel)
# - Fixes unwanted auto-selection: details should populate ONLY when the user clicks an item (green).
# - Moves details panel to a full-width bottom panel (below calendar + list), matching your screenshot expectation.
# - Also removes the generic "Placeholder screen" card for Follow Ups in App.tsx.
#
# IMPORTANT: Does NOT run npm run dev.
#
# Run from: PS C:\Github\QuoteSync\web\ps1_patches>
#   Unblock-File .\20260304_followups_details_only_on_selected_move_to_bottom_20260304_114427.ps1
#   pwsh -ExecutionPolicy Bypass -File .\20260304_followups_details_only_on_selected_move_to_bottom_20260304_114427.ps1
