# QuoteSync patch: Filled Status dropdown colours + "Status" header (Open=orange, Order=green, Lost=red) in Estimates tab
# Applies to the Status dropdown (option 1).
#
# IMPORTANT:
...
#   Unblock-File .\20260304_estimate_status_dropdown_filled_colors_label_20260304_132947.ps1
#   pwsh -ExecutionPolicy Bypass -File .\20260304_estimate_status_dropdown_filled_colors_label_20260304_132947.ps1
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div style={ display: "flex", flexDirection: "column", gap: 4, alignItems: "flex-start" }>
                      <div style={ fontSize: 12, fontWeight: 900, color: "#111827", paddingLeft: 2 }>Status</div>
                      <select
                value={outcome}
                onChange={(ev) = style={ ...qsOutcomeStyle(outcome), height: 34, padding: "0 10px", borderRadius: 999, outline: "none" }> {
