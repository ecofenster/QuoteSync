# QuoteSync patch: Fix Follow Ups rendering in App.tsx (replace "Coming soon" stub with FollowUpsFeature)
# - Adds FollowUpsFeature import after the last import (if missing)
# - Replaces the exact Follow Ups stub block with <FollowUpsFeature .../>
#
# IMPORTANT: Does NOT run npm run dev.
#
# Run from: PS C:\Github\QuoteSync\web\ps1_patches>
#   Unblock-File .\20260304_fix_followups_render_in_app_20260304_115211.ps1
#   pwsh -ExecutionPolicy Bypass -File .\20260304_fix_followups_render_in_app_20260304_115211.ps1
