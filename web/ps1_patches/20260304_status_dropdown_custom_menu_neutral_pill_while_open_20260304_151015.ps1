# QuoteSync patch: Status dropdown per-option colours + neutral pill while menu open
# Replaces native <select> (cannot style per-option reliably) with a tiny custom menu.
# - Options are coloured (Open orange / Order green / Lost red)
# - Pill stays NEUTRAL (white) while menu is open; colour applies when closed.
#
# IMPORTANT:
...
#   Unblock-File .\20260304_status_dropdown_custom_menu_neutral_pill_while_open_20260304_151015.ps1
#   pwsh -ExecutionPolicy Bypass -File .\20260304_status_dropdown_custom_menu_neutral_pill_while_open_20260304_151015.ps1
