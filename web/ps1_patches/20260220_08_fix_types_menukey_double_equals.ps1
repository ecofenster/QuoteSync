# =====================================================================
# QuoteSync — Hotfix: Fix MenuKey typo (remove double '=')
# Script: 20260220_08_fix_types_menukey_double_equals.ps1
...
$txt = Get-Text $typesPath

# Fix exactly one occurrence of: export type MenuKey = =
Ensure-Once "types.ts has MenuKey double '='" $txt "export type MenuKey\s*=\s*="
Replace-Once "types.ts fix MenuKey double '='" ([ref]$txt) "export type MenuKey\s*=\s*=" "export type MenuKey ="

Set-Text $typesPath $txt
