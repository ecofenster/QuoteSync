<# 
QuoteSync Patch — Client Database search/filter/sort + rename Estimate Selection
Applies ONLY:
- App.tsx
  - Search bar above menu
  - Filters: All / Open / Orders / Lost
  - Sort: Ascending / Descending
- EstimatePickerFeature.tsx
  - Rename "Estimate Picker" to "Estimate Selection"
  - Reduce excessive empty space in no-client fallback
...
'@ | Set-Content -Path $epPath -Encoding UTF8

Ok "Patched App.tsx"
Ok "Patched EstimatePickerFeature.tsx"
