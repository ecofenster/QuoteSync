# QuoteSync - HARD FIX: remove broken Follow Ups insertion + reinsert safely + fix MenuKey/sidebar
# File: 20260219_followups_hard_fix.ps1
...
#    (This causes: Unexpected token, expected "..." at the follow_ups line.)
# ------------------------------------------------------------
...
"@
  ...
  $insert = $insert.Replace('            {menu === "follow_ups" && view === "customers" && (
              <Card style={{ minHeight: 520 }}>
                <div style={{ padding: 10 }}>
                  <H2>Follow Ups</H2>
                  <Small>Coming soon.</Small>
