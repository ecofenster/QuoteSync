# QuoteSync patch: Status dropdown menu neutral; Status pill colour changes only after selection
# Requested UX:
# - Dropdown list rows are neutral (no orange/green/red in the menu)
# - The Status pill shows the current outcome colour (Open=orange, Order=green, Lost=red)
#   and therefore only changes once an option is selected.
#
# IMPORTANT:
...
#   Unblock-File .\20260304_status_dropdown_neutral_menu_pill_colours_on_select_20260304_154823.ps1
#   pwsh -ExecutionPolicy Bypass -File .\20260304_status_dropdown_neutral_menu_pill_colours_on_select_20260304_154823.ps1
