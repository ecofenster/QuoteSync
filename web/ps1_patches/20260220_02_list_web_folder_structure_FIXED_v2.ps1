...
Fix v2: Allow empty prefix (do not bind empty string to mandatory param)
Date: 2026-02-20
...
Write-Host "Run directory (curr) : $((Get-Location).Path)"
...
# Note: omit -prefix entirely to avoid empty-string binding issues in some hosts
Add-Tree -dir $WebRoot -lines $lines
