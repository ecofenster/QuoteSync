...
import {createInstallationDocumentsRouter} from './routes/installationDocuments.js';
...
app.use('/api/installation-documents',createInstallationDocumentsRouter({databasePromise:dbPromise}));
