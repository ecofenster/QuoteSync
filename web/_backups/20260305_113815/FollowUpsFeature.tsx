...
export default function FollowUpsFeature({ clients, onOpenClient }: Props) {
  ...
  const [clientNoteDraft, setClientNoteDraft] = useState<string>("");useEffect(() => {
    saveFollowUps(items);
  }, [items]);
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gridTemplateRows: "auto auto", gap: 12, minHeight: 520 }}>
      ...
      {/* Left: Calendar */}
      <div style={{ gridColumn: "1", gridRow: "1", border: "1px solid #e4e4e7", borderRadius: 16, overflow: "hidden", background: "#fff" }}>
      ...
      {/* Right: List */}
      <div style={{ gridColumn: "2", gridRow: "1", border: "1px solid #e4e4e7", borderRadius: 16, overflow: "hidden", background: "#fff" }}>
      ...
      <div style={{ gridColumn: "1", gridRow: "2", border: "1px solid #e4e4e7", borderRadius: 16, overflow: "hidden", background: "#fff" }}>
        <div style={{ padding: 12, borderBottom: "1px solid #f1f5f9" }}>
