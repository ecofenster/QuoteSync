...
const PRODUCT_TYPES: Models.ProductType[] = ["uPVC", "uPVC Alu Clad", "Timber", "Timber Aluminium Clad", "Aluminium", "Steel"];
...
function isTimberProductType(t: Models.ProductType) {
  return t === "Timber" || t === "Timber Aluminium Clad";
}

/* --- finishes: typeahead dropdown via datalist --- */
const FINISHES_BY_TYPE: Record<Models.ProductType, { external: string[]; internal: string[] }> = {
