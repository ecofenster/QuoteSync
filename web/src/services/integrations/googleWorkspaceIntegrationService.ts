...
export const googleWorkspaceIntegrationService={
  ...
  configure:(input:{clientId:string;clientSecret?:string;redirectUri:string;enquiriesRootFolderId?:string|null;estimatesRootFolderId?:string|null;ordersRootFolderId?:string|null;workforceRootFolderId?:string|null;folderTemplate?:Record<string,string>})=>apiFetch("/api/integrations/googleWorkspace/config",{method:"PUT",headers:json,body:JSON.stringify(input)}) as Promise<GoogleWorkspaceStatus>,
