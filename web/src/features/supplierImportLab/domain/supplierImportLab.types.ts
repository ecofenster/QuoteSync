...
export type ManufacturerPositionEvidence = { manufacturerName?: string | null; canonicalManufacturer?: { manufacturerId: string; manufacturerName: string; manufacturerCode: string | null; compatibilityIdentity?: boolean }; manufacturerSystemIdentity?: { manufacturerId: string; manufacturerCode: string | null; manufacturerName: string; systemCode: string; identity: string } | null; documentIssuer?: { name: string | null; legalName: string | null; authority: string }; commercialSupplier?: { supplierCode: string; supplierName: string; proposedSourceName?: string | null; proposalAuthority?: string | null }; supplierManufacturerRelationship?: { relationship: "direct_manufacturer_supplier" | "dealer_supplies_manufacturer_products"; manufacturerId: string; manufacturerName: string; supplierCode: string; supplierName: string; commercialSupplierCode?: string; commercialSupplierName?: string; documentIssuerName?: string | null; documentIssuerLegalName?: string | null; supplierSourceName: string; supplierSourceLegalName: string; pricingScope: "supplier_dealer_quotation" | "commercial_supplier_quotation" }; manufacturerItemNumber: string | null; customerReference: string | null; roomLocation: string | null; product: string | null; productSystem: string | null; productType: "Window" | "Door" | null; configurationDescription: string | null; areaSquareMetres: string | null; weightKg: string | null; glassSpecification: string | null; fittingsSpecification: string | null; manufacturerQuotedUg: string | null; manufacturerQuotedUw: string | null; customerSafeSpecification: Array<{ ordinal: number; label: string; value: string }>; sourceSpecification?: ManufacturerSourceSpecification | null; canonicalSpecification?: Record<string, unknown>; sourceVisuals?: ManufacturerSourceVisual[]; sourceVisual: ManufacturerSourceVisual };
