...
export type ManufacturerPositionEvidence = { manufacturerItemNumber: string | null; customerReference: string | null; roomLocation: string | null; product: string | null; productSystem: string | null; productType: "Window" | "Door" | null; configurationDescription: string | null; areaSquareMetres: string | null; weightKg: string | null; glassSpecification: string | null; fittingsSpecification: string | null; manufacturerQuotedUg: string | null; manufacturerQuotedUw: string | null; customerSafeSpecification: Array<{ ordinal: number; label: string; value: string }>; sourceVisual: { kind: "manufacturer_document_image"; status: "available" | "unavailable"; sourceFormat?: string | null; mappingMethod?: string; mappingConfidence?: "strong" | "review"; mappingReviewStatus?: "mapped_automatic" | "needs_review" | "unavailable"; mediaType?: string; url?: string; reason?: string | null; renderedDerivative?: { mediaType: string; url: string; widthPx: number | null; heightPx: number | null; dpi: number | null; purpose: string } | null } };
