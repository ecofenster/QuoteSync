...
await build({entryPoints:['tests/stage2a-project-calculator-lab.test.ts'],outfile,bundle:true,platform:'node',format:'esm',sourcemap:'inline',logLevel:'silent',external:['node:*','sqlite','sqlite3']});
