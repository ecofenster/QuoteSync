...
try {
  ...
  controller.setRun({ label: "project-costing-catalogue-rebind", userDataDir: profile, debugPort, startedAt: new Date().toISOString(), profileProcessCountBefore: await countBrowserRunProfiles(profile, { platformName: process.platform }) });
  ...
  assert(supplierBefore.installation.includes("Supplier installation available") && supplierBefore.installation.includes("ecoHaus") && supplierBefore.installation.includes("£10,939.15"), "Supplier installation evidence was not presented under Installation");
  ...
  assert(selectedInstallationText.includes("Supplier installation selected") && selectedInstallationText.includes("£10,939.15"), "Supplier installation did not become the active substitute");
