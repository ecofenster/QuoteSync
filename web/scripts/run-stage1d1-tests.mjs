...
await build({ entryPoints: ["tests/stage1d1-supplier-import-lab.test.ts"], outfile, bundle: true, platform: "node", format: "esm", sourcemap: "inline", logLevel: "silent", external: ["node:*", "express", "multer", "sqlite", "sqlite3", "mammoth", "pdfjs-dist/*"] });
