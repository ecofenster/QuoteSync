...
await build({ entryPoints: ["tests/stage1d-supplier-upload.test.ts"], outfile, bundle: true, platform: "node", format: "esm", sourcemap: "inline", logLevel: "silent", external: ["node:*", "express", "multer", "sqlite", "sqlite3", "react", "react-dom", "mammoth", "pdfjs-dist/*"] });
