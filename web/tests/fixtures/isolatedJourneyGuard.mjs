...
export function isolatedJourneyMode(environment=process.env){
 ...
 const factoryDelivery=['factory-send','factory-reconcile','supplier-followup','supplier-reconcile','followup-reconcile'].includes(environment.QUOTESUITE_DISPOSABLE_PROVIDER_DELIVERY);
