...
type View = "customers" | "estimate_picker" | "estimate_defaults" | "estimate_workspace";
...
export default function App() {
  ...
  function createClient(type: ClientType) {
    const projectAddressStr = [
      draftSiteAddress1.trim(),
      draftSiteAddress2.trim(),
      draftSiteAddress3.trim(),
      draftSiteTown.trim(),
      draftSiteCity.trim(),
      draftSiteCounty.trim(),
      draftSitePostcode.trim(),
    ]
      .filter(Boolean)
      .join("\n");

    const invoiceAddressStr = draftInvoiceDifferent
      ? [
    ...
    setDraftInvoiceDifferent(false);
    setDraftInvAddr1("");
    setDraftInvAddr2("");
    setDraftInvAddr3("");
    setDraftInvTown("");
                        ...
                        <div style={{ marginTop: 10, display: "grid", gap: 12 }}>
                          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                            <div>
                              ...
                              <Input value={draftProjAddr1} onChange={setDraftProjAddr1} placeholder="Address line 1" />
                            </div>
                            <div>
                              <div style={labelStyle}>Address line 2</div>
                              <Input value={draftProjAddr2} onChange={setDraftProjAddr2} placeholder="Address line 2" />
                            </div>
                          </div>

                          <div>
                            <div style={labelStyle}>Address line 3</div>
                            <Input value={draftProjAddr3} onChange={setDraftProjAddr3} placeholder="Address line 3" />
                          </div>
                          ...
                          <div style={{ marginTop: 6 }}>
                            <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, fontWeight: 800 }}>
                              <input
                                type="checkbox"
                                checked={draftInvoiceDifferent}
                                onChange={(e) => setDraftInvoiceDifferent(e.currentTarget.checked)}
                              />
                              Invoice address different
                            </label>
                          </div>

                          {draftInvoiceDifferent && (
                            <div style={{ marginTop: 10, borderRadius: 12, border: "1px solid #e4e4e7", padding: 12, background: "#fafafa" }}>
                              ...
                              <div style={{ marginTop: 10, display: "grid", gap: 12 }}>
                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                                  <div>
                                    <div style={labelStyle}>Address line 1</div>
                                    <Input value={draftInvAddr1} onChange={setDraftInvAddr1} placeholder="Address line 1" />
                                  </div>
                                  <div>
                                    <div style={labelStyle}>Address line 2</div>
                                    <Input value={draftInvAddr2} onChange={setDraftInvAddr2} placeholder="Address line 2" />
                                  </div>
                                </div>

                                <div>
                                  <div style={labelStyle}>Address line 3</div>
                                  <Input value={draftInvAddr3} onChange={setDraftInvAddr3} placeholder="Address line 3" />
                                </div>
