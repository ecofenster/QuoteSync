...
# Applies incremental change to src\App.tsx only.
#
# Run from: PS C:\QuoteSync\web>
#
# What it does:
# - Backs up .\src\App.tsx to C:\QuoteSync\_backups\quotesync_patch\
...
$expected = "C:\QuoteSync\web"
if ((Get-Location).Path -ne $expected) {
  Write-Host "Switching to: $expected"
...
$backupRoot = "C:\QuoteSync\_backups\quotesync_patch"
...
Write-Host ""
Write-Host "Done. Start dev server as you normally do (e.g., npm run dev)." -ForegroundColor Cyan
