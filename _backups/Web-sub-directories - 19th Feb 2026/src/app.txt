              ...
              <Card style={{ minHeight: 520 }}>
                  ...
                  <div style={{ marginTop: 14, borderRadius: 16, border: "1px solid #e4e4e7", padding: 12, background: "#fff" }}>
                    ...
                    <div style={{ marginTop: 10, display: "grid", gap: 12 }}>
                      ...
                      <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
                        <Button variant="secondary" onClick={closeAddClient}>Cancel</Button>
                ...
                <div style={{ marginTop: 14, display: "grid", gap: 10 }}>
                  {filteredClients.length === 0 && (
                    <div style={{ fontSize: 13, color: "#71717a" }}>No clients yet.</div>
                  )}
                      ...
                      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
                        <div>
                          <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                            ...
                            <div style={{ fontWeight: 900, fontSize: 14, color: "#18181b" }}>
                              {c.type === "Business" ? (c.businessName || c.clientName) : c.clientName}
                            </div>
                          </div>
                          <div style={{ marginTop: 6, fontSize: 12, color: "#71717a" }}>
                            {c.projectName || "—"} • {c.projectAddress ? c.projectAddress.split("\n")[0] : "—"}
                          </div>
                        </div>
                        ...
                        <div style={{ marginTop: 10, borderTop: "1px solid #e4e4e7", paddingTop: 10 }}>
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
                            ...
                            <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                              <Button variant="secondary" onClick={toggleEstimateCompleted}>
                                Toggle status
                              </Button>
                              <Button
                                variant="secondary"
                              ...
                              <div key={e.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
                                <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                                  <input
                                    ...
                                    onChange={(ev) =>
                                      setRevisionSelection((prev) => ({ ...prev, [e.id]: ev.target.checked }))
                                    }
                                  />
